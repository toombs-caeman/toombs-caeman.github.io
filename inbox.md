...
* be lazy with the unimportant
* virtual assistants (tim ferris)
* putting things out of your mind (lists) or dealing with intrusive thoughts/obsessions
* checklists
* journaling
* dissociation meditation
* effective executive * time audits
    * yearly "intensive month" for increased time tracking and moving forward, other long term calendars

* draining the shallows
    * be wary of taking on shallow work
    * schedule every minute of the day to stay mindful of the value proposition.
        * the schedule is to force forethought, so it should flex and be updated continuously
    * in every moment: "what is the most valuable thing to do right now?"
    * quantify the depth of every task: "how long would it take to train a smart but naive new grad to complete the task?"
        * for super shallow work, it might even be effective to actually do so
    * timebox your work, then optimize to fit the time
    * be hard to reach, make them work for it, set expectations early, and cut down back and forths/low stakes negotiations. Don't respond.
* cutting out distractions can reveal certain mental/emotional issues. Ignoring them will not make them go away. Need to
    deal with these as they arise or always be running.
## Cut to the heart
* single pointed concentration
* attention training technique

## taming the mind ruth#2
1. start by relaxing your body
2. focus on the breath
3. decrease wandering, perhaps with a mantra
4. practice 20-30 minutes a day

the reward for taming the mind is clarity of thought
    
## Cut to the chase
* death meditation
* mental subtraction (meditation on the absence of a present pleasure)
* making time
...
* create a shutdown ritual
    * zeigarnik effect
    * plan the next session and write it all down to truly rest
    * don't work after the shutdown
## References
* http://onezero.medum.com/being-indistractable-will-be-the-skill-of-the-future-a07780cf36f4
* deep work cal newport
* flow
* the effective executive drucker
* the rise of superman kofler
...
The __outcome__ should be framed directly in terms of the metric you chose.
...
alternative meanings: https://www.youtube.com/watch?v=0Mi9_XEXQqc
Agreed on
Realistic
Time-based
...
* performance goals can have a negative effect on a group's performance if there is a perceived conflict of interest
    among group members.
...
Often we think of the response as a single unit of action, but really, if the habit takes more than about 2 minutes to 
...
the philosophical basis of learning should be self consistent, focused, partially derived from norms and balanced with 
